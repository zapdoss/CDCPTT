...
public class Singleton_helper extends Application {
	private final static String LOG_TAG				= "Singleton_helper";
	private static Singleton_helper m_Instance;
	...
	public Singleton_helper() {
		super();
		m_Instance = this;
	}
	
	public static Singleton_helper getInstance() {
		if(m_Instance == null) {
			synchronized(Singleton_helper.class) {
				if(m_Instance == null) new Singleton_helper();
			}
		}
		return m_Instance;
	}
